      ...
      <Grid templateColumns='repeat(4, 1fr)'>
        ...
        <GridItem colSpan={{sm:4, md:2}} mt={{md:"10px" , lg:"110px"}} display={{sm:isShwoImage, md:"inline"}}>
          <Grid templateColumns='repeat(5, 1fr)'>
            ...
            <GridItem colSpan={{sm:5, md:3}}>
              ...
              <Box width={{sm:"100%", md:"85%", lg:"100%"}} border="1.5px solid #A0FFA0" borderRadius="14px" borderColor="#A0FFA0" mb={{sm:"8px",lg:"0px"}}>
                <Box display={{sm:"flex"}}>
        ...
        <GridItem colSpan={{sm:4, md:1}} bg="rgba(196, 196, 196, 0.1)" ml={{sm: "0px", md: "6.25%"}} display={isShwoMenu}>
          ...
          <Box py={{sm:"25px", md:"10px", lg:"50px"}} bg="#201727">
            <Text fontSize="25px" ml="60px">Add at least one picture to your profile</Text>
          </Box>
          <Box ml="47px" mt={{sm:"30px", md:"25px", lg:"34px"}} mb={{sm:"30px", md:"25px", lg:"240px"}}>
            <Flex direction="row" maxW={{sm:"100%", md:"40vh"}} overflow="hidden">
              <Box mx="13px" minW="150px" height="187px" bg="rgba(10, 7, 12, 0.25)" borderRadius="14px" >
                <Center mt="68px">
                  <Image src="../assests/add.svg" alt="add" width="52px" m="atuo"></Image>
                </Center>                 
              </Box>
              <Box mx="13px" minW="150px" height="187px" bg="rgba(10, 7, 12, 0.25)" borderRadius="14px" ></Box>
              <Box mx="13px" minW="150px" height="187px" bg="rgba(10, 7, 12, 0.25)" borderRadius="14px" ></Box>
            </Flex>
          </Box>
          <Box mt={{sm:"40px", md:"40px", lg:"195px"}} mb={{sm:"36px", md:"36px", lg:"105px"}}>
            <Center>
              <Link to="/signup"><Customgraybutton ButtonName="Continue"/></Link>                
            </Center>            
          </Box>          
        </GridItem>
      </Grid>      
